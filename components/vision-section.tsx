    ...
    <section className="py-24 px-4 md:px-8 bg-background border-b border-border">
      <div className="max-w-4xl mx-auto">
        <div className="bg-card border border-border rounded-2xl p-8 md:p-12">
          <p className="text-accent text-sm font-medium tracking-wider uppercase mb-4">Our Vision</p>

          <h2 className="text-3xl md:text-4xl font-bold mb-8 text-balance leading-tight">
            Not all hackerhouses are to onboard new projects
          </h2>

          <p className="text-gray-300 text-lg mb-8">
            Some of them are to scale up the existing ones. We're building an ecosystem where builders, creators, and
          ...
          <div className="pt-8 border-t border-border">
            <p className="text-sm text-gray-400 mb-4">📍 Date, Location & Excess Information Coming Soon</p>
